...
<div class="modal fade" id="payable_modal" tabindex="-1" role="dialog" aria-labelledby="payableLabel" aria-hidden="true">
                ...
                <div class="mb-2">
                   ...
                   <label class="label">Please Select File</label>
                        ...
                        <div class="field is-grouped is-grouped-centered">
                            <div class="control">
                                <button type="button" class="button is-link btn_payroll_upload">Submit</button>
                            </div>
                            <div class="control">
                                <button type="button" class="button is-link is-danger btn_payroll_cancel">Cancel</button>
                            </div>
                        </div>
                        <input type="hidden" name="payable_id" id="payable_id" value="">
                   </form>
                </div>
            </div>
        </div>
